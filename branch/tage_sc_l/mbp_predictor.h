...
//     virtual std::pair <branch_info*, int> lookup(unsigned int pc) = 0;
...
//     virtual bool filter_always_never(void) {
//       return true;
//     }

//     virtual void nonconditional_branch(unsigned int pc) { }

//     virtual const char* name(bool) {
//       return "";
//     }
...
//     std::pair<bool, int> GetPrediction(uint64_t PC);
...
//     std::pair <branch_info*, int> lookup(unsigned int pc) {
...
//   { MBP_GHIST, 0, 19, 1, 1.4375, 0, 6 },
//   { MBP_GHIST, 0, 65, 1, 1.0, 0, 6 },
//   { MBP_GHIST, 21, 64, 1, 1.0, 0, 6 },
//   { MBP_GHIST, 75, 150, 1, 1.0625, 0, 6 },
...
//   MBP_PREDICTOR::MBP_PREDICTOR(void) {
...
//   std::pair<bool, int> MBP_PREDICTOR::GetPrediction(uint64_t PC) {
//     auto u = ex->lookup(PC);
//     return std::pair{ u.first->prediction(), u.second };
//   }

//   void MBP_PREDICTOR::UpdatePredictor(uint64_t PC, uint8_t opType, bool resolveDir, bool predDir, uint64_t branchTarget) {
//     ex->update(u, branchTarget, resolveDir, opType);
//   }

//   void MBP_PREDICTOR::TrackOtherInst(uint64_t PC, uint8_t opType, bool branchDir, uint64_t branchTarget) {
//     ex->nonconditional_branch(PC);
//   }


//   void MBP_PREDICTOR::speculative_begin() {

//   }
//   void MBP_PREDICTOR::speculative_end() {
