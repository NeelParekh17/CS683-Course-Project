...
{
  // std::cout << "operate addr " << addr << " cache_hit " << int(cache_hit) << " type " << int(type) << std::endl;
...
{
  // std::cout << "fill addr " << addr << " set " << int(set) << " way "
  //   << int(way) << " eva " << int(evicted_addr) << " prefetch "
  //   << int(prefetch) << std::endl;
